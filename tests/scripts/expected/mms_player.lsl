...
default
{
    state_entry()
    {
        ...
        if (/*num_clips*/_a > 0)
        {
            ...
            /*total_time*/_16 = /*format_time*/_8((integer)(/*num_clips*/_a * 9));
        }
        llStopSound();
...
state /*preload*/_d
{
    state_entry()
    {
        /*send_message*/_14(21000, [/*num_clips*/_a, 9]);
...
state /*playing*/_c
{
    state_entry()
    {
        ...
        llResetTime();
        if (1)
            llSetTextureAnim(35, ALL_SIDES, 0, 0, 0, TWO_PI, 30);
        /*play_next_clip*/_b();
    ...
    timer()
    {
        if ((integer)((llGetTime() + 1) / 9) >= /*clip_playing*/_1)
        {
            /*play_next_clip*/_b();
            /*preload_next_clip*/_e(FALSE);
            if (/*clip_playing*/_1 >= /*num_clips*/_a)
