script [none] (cv=) (2,1)
  ...
  global storage [none] (cv=) (5,1)
    global var [] (cv=) (5,1)
      ...
      quaternion expression [error] (cv=) (5,14)
  ...
  global storage [none] (cv=) (6,1)
    global var [] (cv=) (6,1)
      ...
      quaternion expression [error] (cv=) (6,14)
  ...
  global storage [none] (cv=) (7,1)
    global var [] (cv=) (7,1)
      ...
      list expression [error] (cv=) (7,12)
        quaternion expression [error] (cv=) (7,13)
    ...
    event handler [none] (cv=) (24,5)
      ...
      compound statement [none] (cv=) (24,32)
        ...
        declaration [] (cv=) (42,9)
          ...
          vector expression [error] (cv=) (42,20)
        ...
        declaration [] (cv=) (43,9)
          ...
          quaternion expression [error] (cv=) (43,22)
        ...
        declaration [] (cv=) (44,9)
          ...
          list expression [error] (cv=) (44,20)
            quaternion expression [error] (cv=) (44,21)
        ...
        statement [none] (cv=) (46,9)
          function call [none] (cv=) (46,9)
            ...
            binary expression: '+' [error] (cv=string constant: `foofoo') (46,20)
              lvalue expression {foldable} [key] (cv=string constant: `foo') (46,20)
